...
def check_tshark_availability():
    ...
    if not tshark_path:
        ...
        if os_type == "Linux":
            print("sudo apt update && apt install tshark")
        elif os_type == "Darwin":
            print("https://www.wireshark.org/download.html")
        else:
            print("Install TSSHARK")
        sys.exit(1)
    else:
        print("[+] TSSHARK Работает")
...
def parse_arguments():
    parser = argparse.ArgumentParser(
        description='Определяю айпишник, вейт')
